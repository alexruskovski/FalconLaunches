...
package com.alexruskovski.falcon.ui.state

import com.alexruskovski.falcon.data.Result
import com.alexruskovski.falcon.exceptions.ExceptionsBase
...
data class UiState<T>(
    ...
    val exception: ExceptionsBase? = null,
    val data: T? = null
) {
    /**
...
fun <T> UiState<T>.copyWithResult(value: Result<T>): UiState<T> {
    return when (value) {
        ...
        is Result.EmptyResponse -> copy(loading = false, exception = null, data = null)
    }
}
